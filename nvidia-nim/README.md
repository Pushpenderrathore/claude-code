...
<div align="center">
  <a href="https://star-history.com/#Pushpenderrathore/claude-code&Date">
    <picture>
      <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/svg?repos=Pushpenderrathore/claude-code&type=Date&theme=dark">
      <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/svg?repos=Pushpenderrathore/claude-code&type=Date">
      <img alt="Star History Chart" src="https://api.star-history.com/svg?repos=Pushpenderrathore/claude-code&type=Date" width="700">
    </picture>
  </a>
</div>
...
- `claude-code`: compatibility alias for `fcc-server`.
...
- Report bugs and feature requests in [Issues](https://github.com/Pushpenderrathore/claude-code/issues).
